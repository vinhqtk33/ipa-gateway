  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ipaGatewayApp.ipaCatalogBookServiceBook.home.createOrEditLabel" data-cy="BookCreateUpdateHeading">
            <Translate contentKey="ipaGatewayApp.ipaCatalogBookServiceBook.home.createOrEditLabel">Create or edit a Book</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ipaGatewayApp.ipaCatalogBookServiceBook.name')}
                id="book-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('ipaGatewayApp.ipaCatalogBookServiceBook.description')}
                id="book-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField
                label={translate('ipaGatewayApp.ipaCatalogBookServiceBook.price')}
                id="book-price"
                name="price"
                data-cy="price"
                type="text"
